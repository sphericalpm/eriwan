...
def test_text_to_speech():
    ...
    test_audio_path = os.path.join(script_path, "tests", "test_data", 'test_audio.mp3')
...
def test_concatenate_audios():
    script_path = path.abspath(path.join(os.getcwd()))
    test_audio_path = os.path.join(script_path, "tests", "test_data", 'test_audio_with_jingle.mp3')
    
    concatenate_audio_path = os.path.join(script_path, "tests", "test_data",  "jingle_and_joke.mp3")
